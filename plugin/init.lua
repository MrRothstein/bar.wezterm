...
local function get_require_path()
  local path = "httpssCssZssZsgithubsDscomsZsMrRothsteinsZsbarsDswezterm"
  local path_trailing_slash = "httpssCssZssZsgithubsDscomsZsadriankarlensZsbarsDswezterm"
